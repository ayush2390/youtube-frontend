  ...
  useEffect(() => {
    const fetchToken = async () => {
      try {
        ...
        const response = await fetch("https://youtube-token.onrender.com/api/token");
        const data = await response.json();
        setPoToken(data.poToken);
  ...
  const downloadVideo = async (method) => {
    ...
    try {
      const response = await fetch(
        "https://youtube-backend-dualite.onrender.com/download",
        // "http://127.0.0.1:5000/download",
        {
          ...
          body: JSON.stringify({ url, method, count, poToken }),
        }
      );
      ...
      if (response.ok) {
        ...
        console.log(data.error || "Failed to download");
      }
    } catch (error) {
            ...
            <div className="max-w-[1260px] w-full box-border min-h-[284px] opacity-[1] z-[2]  rotate-[0deg]   flex flex-col flex-nowrap justify-center items-start gap-[30px] p-[30px_40px_30px__40px] rounded-tl-[16px] rounded-tr-[16px] rounded-br-[16px] rounded-bl-[16px] bg-[#ffffffff] [box-shadow:inset_0_0_0_1.5px_#3b304cff,inset_0_0_1.5px_0_#3b304cff,inset_0_1.5px_0_0_#3b304cff,inset_1.5px_0_0_0_#3b304cff] border-l-[1px] border-l-[#3b304cff] border-r-[1px] border-r-[#3b304cff] border-t-[1px] border-t-[#3b304cff] border-b-[1px] border-b-[#3b304cff]">
              ...
              <div className="max-w-[1180px] w-full box-border min-h-[62px] opacity-[1] z-[1]  rotate-[0deg]   flex flex-wrap justify-start items-center gap-[21px] gap-y-[21px] p-[0px_0px_0px__0px]">
                ...
                <div
                  ...
                  className="max-w-[130px] w-full box-border hover:translate-y-[-4px] hover:shadow-[5px_8px_15px_rgba(0,0,0,0.3)] cursor-pointer min-h-[62px] opacity-[1] z-[1]  rotate-[0deg]   flex flex-nowrap justify-center items-center gap-[16px] p-[12px_0px_14px__0px] rounded-tl-[12px] rounded-tr-[12px] rounded-br-[12px] rounded-bl-[12px] bg-[#ff4f51ff] [box-shadow:inset_0_0_0_1.5px_#000000ff,inset_0_0_1.5px_0_#000000ff,inset_0_1.5px_0_0_#000000ff,inset_1.5px_0_0_0_#000000ff] border-l-[1px] border-l-[#000000ff] border-r-[1px] border-r-[#000000ff] border-t-[1px] border-t-[#000000ff] border-b-[1px] border-b-[#000000ff] shadow-[3px_4px_0px_0px_rgba(15,15,15,1)]"
                  onClick={() => downloadVideo("itag_18")}
                >
                  <div className="max-w-[74px] cursor-pointer w-full box-border min-h-[36px] flex justify-center opacity-[1] z-[0]  rotate-[0deg]   text-left leading-[0px]">
                    <span className="text-[28px] cursor-pointer pt-1 font-hanken font-bold font-[700] no-underline none tracking-[-1.4px] leading-[28px] whitespace-nowrap text-[#ffffffff]">
                      {pQualityOption}
                    </span>
                  </div>
                </div>
                ...
                <div
                  ...
                  className="max-w-[130px] w-full box-border hover:translate-y-[-4px] hover:shadow-[5px_8px_15px_rgba(0,0,0,0.3)] cursor-pointer min-h-[62px] opacity-[1] z-[2]  rotate-[0deg]   flex flex-nowrap justify-center items-center gap-[16px] p-[12px_0px_14px__0px] rounded-tl-[12px] rounded-tr-[12px] rounded-br-[12px] rounded-bl-[12px] bg-[#ff4f51ff] [box-shadow:inset_0_0_0_1.5px_#000000ff,inset_0_0_1.5px_0_#000000ff,inset_0_1.5px_0_0_#000000ff,inset_1.5px_0_0_0_#000000ff] border-l-[1px] border-l-[#000000ff] border-r-[1px] border-r-[#000000ff] border-t-[1px] border-t-[#000000ff] border-b-[1px] border-b-[#000000ff] shadow-[3px_4px_0px_0px_rgba(15,15,15,1)]"
                  onClick={() => downloadVideo("itag_18")}
                >
                ...
                <div
                  ...
                  className="max-w-[115px] w-full box-border hover:translate-y-[-4px] hover:shadow-[5px_8px_15px_rgba(0,0,0,0.3)] cursor-pointer min-h-[62px] opacity-[1] z-[3]  rotate-[0deg]   flex flex-nowrap justify-center items-center gap-[16px] p-[12px_0px_14px__0px] rounded-tl-[12px] rounded-tr-[12px] rounded-br-[12px] rounded-bl-[12px] bg-[#ff4f51ff] [box-shadow:inset_0_0_0_1.5px_#000000ff,inset_0_0_1.5px_0_#000000ff,inset_0_1.5px_0_0_#000000ff,inset_1.5px_0_0_0_#000000ff] border-l-[1px] border-l-[#000000ff] border-r-[1px] border-r-[#000000ff] border-t-[1px] border-t-[#000000ff] border-b-[1px] border-b-[#000000ff] shadow-[3px_4px_0px_0px_rgba(15,15,15,1)]"
                  onClick={() => downloadVideo("highest_resolution")}
                >
                ...
                <div
                  ...
                  className="max-w-[115px] w-full box-border hover:translate-y-[-4px] hover:shadow-[5px_8px_15px_rgba(0,0,0,0.3)] cursor-pointer min-h-[62px] opacity-[1] z-[4]  rotate-[0deg]   flex flex-nowrap justify-center items-center gap-[16px] p-[12px_0px_14px__0px] rounded-tl-[12px] rounded-tr-[12px] rounded-br-[12px] rounded-bl-[12px] bg-[#ff4f51ff] [box-shadow:inset_0_0_0_1.5px_#000000ff,inset_0_0_1.5px_0_#000000ff,inset_0_1.5px_0_0_#000000ff,inset_1.5px_0_0_0_#000000ff] border-l-[1px] border-l-[#000000ff] border-r-[1px] border-r-[#000000ff] border-t-[1px] border-t-[#000000ff] border-b-[1px] border-b-[#000000ff] shadow-[3px_4px_0px_0px_rgba(15,15,15,1)]"
                  onClick={() => downloadVideo("highest_resolution")}
                >
                  <div className="max-w-[59px] w-full box-border min-h-[36px] flex justify-center opacity-[1] z-[0]  rotate-[0deg]   text-left leading-[0px]">
                    <span className="text-[28px] pt-1 font-hanken font-bold font-[700] no-underline none tracking-[-1.4px] leading-[28px] whitespace-nowrap text-[#ffffffff]">
                ...
                <div
                  ...
                  className="max-w-[115px] w-full box-border hover:translate-y-[-4px] hover:shadow-[5px_8px_15px_rgba(0,0,0,0.3)] cursor-pointer min-h-[62px] opacity-[1] z-[5]  rotate-[0deg]   flex flex-nowrap justify-center items-center gap-[16px] p-[12px_0px_14px__0px] rounded-tl-[12px] rounded-tr-[12px] rounded-br-[12px] rounded-bl-[12px] bg-[#ff4f51ff] [box-shadow:inset_0_0_0_1.5px_#000000ff,inset_0_0_1.5px_0_#000000ff,inset_0_1.5px_0_0_#000000ff,inset_1.5px_0_0_0_#000000ff] border-l-[1px] border-l-[#000000ff] border-r-[1px] border-r-[#000000ff] border-t-[1px] border-t-[#000000ff] border-b-[1px] border-b-[#000000ff] shadow-[3px_4px_0px_0px_rgba(15,15,15,1)]"
                  onClick={() => downloadVideo("highest_resolution")}
                >
                  <div className="max-w-[59px] w-full box-border min-h-[36px] flex justify-center opacity-[1] z-[0]  rotate-[0deg]   text-left leading-[0px]">
                    <span className="text-[28px] pt-1 font-hanken font-bold font-[700] no-underline none tracking-[-1.4px] leading-[28px] whitespace-nowrap text-[#ffffffff]">
              ...
              <div className="max-w-[1180px] w-full box-border min-h-[62px] opacity-[1] z-[2]  rotate-[0deg]   flex flex-wrap justify-start items-center gap-[21px] gap-y-[21px] p-[0px_0px_0px__0px]">
                ...
                <div
                  ...
                  className="max-w-[156px] w-full hover:translate-y-[-4px] hover:shadow-[5px_8px_15px_rgba(0,0,0,0.3)] box-border min-h-[62px] cursor-pointer opacity-[1] z-[1]  rotate-[0deg]   flex flex-nowrap justify-center items-center gap-[16px] p-[12px_0px_14px__0px] rounded-tl-[12px] rounded-tr-[12px] rounded-br-[12px] rounded-bl-[12px] bg-[#ff4f51ff] [box-shadow:inset_0_0_0_1.5px_#000000ff,inset_0_0_1.5px_0_#000000ff,inset_0_1.5px_0_0_#000000ff,inset_1.5px_0_0_0_#000000ff] border-l-[1px] border-l-[#000000ff] border-r-[1px] border-r-[#000000ff] border-t-[1px] border-t-[#000000ff] border-b-[1px] border-b-[#000000ff] shadow-[3px_4px_0px_0px_rgba(15,15,15,1)]"
                  onClick={() => downloadVideo("itag_128")}
                >
                ...
                <div
                  ...
                  className="max-w-[156px] w-full box-border min-h-[62px] cursor-pointer hover:translate-y-[-4px] hover:shadow-[5px_8px_15px_rgba(0,0,0,0.3)] opacity-[1] z-[2] rotate-[0deg] flex flex-nowrap justify-center items-center gap-[16px] p-[12px_0px_14px_0px] rounded-tl-[12px] rounded-tr-[12px] rounded-br-[12px] rounded-bl-[12px] bg-[#ff4f51ff] [box-shadow:inset_0_0_0_1.5px_#000000ff,inset_0_0_1.5px_0_#000000ff,inset_0_1.5px_0_0_#000000ff,inset_1.5px_0_0_0_#000000ff] border-l-[1px] border-l-[#000000ff] border-r-[1px] border-r-[#000000ff] border-t-[1px] border-t-[#000000ff] border-b-[1px] border-b-[#000000ff] shadow-[3px_4px_0px_0px_rgba(15,15,15,1)]"
                  onClick={() => downloadVideo("itag_128")}
                >
                  <div className="max-w-[100px] w-full box-border min-h-[36px] flex justify-center opacity-[1] z-[0] rotate-[0deg] text-left leading-[0px]">
                    <span className="text-[28px] pt-1 font-hanken font-bold font-[700] no-underline none tracking-[-1.4px] leading-[28px] whitespace-nowrap text-[#ffffffff]">
